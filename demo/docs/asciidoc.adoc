...
* Back to the xref:../index.html[home page]
* External link: https://asciidoctor.org[Asciidoctor documentation]
...
Renderer:: Invokes Asciidoctor as a subprocess to convert `.adoc` files to raw HTML.
HtmlProcessor:: Transforms Asciidoctor HTML output into Zensical-compatible markup.
Config:: Controls safe mode, attributes, and error handling for the rendering pipeline.
